...
# =============================================================================
echo ""
echo "✅ Laravel ready! Starting Supervisor (web + ${QUEUE_HIGH:-high} + ${QUEUE_MEDIUM:-medium}) on port ${PORT:-8080}..."
echo "   Workers: ${QUEUE_HIGH:-high} (1 proc, timeout 1300) + ${QUEUE_MEDIUM:-medium} (1 proc, timeout 1300)"
