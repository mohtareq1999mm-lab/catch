...
class CouponService
{
     ...
     * Assignment-only coupons (assignments, no targeting) are excluded —
     * personal grants belong to My Coupons. Guests see public + targeted
     * rows with codes hidden. Each model carries `discoveryDecision`
    ...
    public function getCoupons($request, ?User $user = null)
    {
        ...
        $models = $coupons
            ->where(function ($query) {
                ...
                // (assignments without targeting) are excluded for everyone:
                // personal grants stay private to assignees via My Coupons.
