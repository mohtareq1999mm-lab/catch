...
return [
    ...
    'MESSAGE.STATIC_SECTION_CREATED_SUCCESSFULLY' => 'Static section created successfully',
    'MESSAGE.STATIC_SECTION_UPDATED_SUCCESSFULLY' => 'Static section updated successfully',
    'MESSAGE.STATIC_SECTION_DELETED_SUCCESSFULLY' => 'Static section deleted successfully',
    'MESSAGE.STATIC_SECTIONS_REORDERED_SUCCESSFULLY' => 'Static sections reordered successfully',
    'MESSAGE.STATIC_SECTION_CONTENT_INVALID' => 'The section content must be an object keyed by locale',
    ...
    'MESSAGE.CATEGORY_BULK_DELETE_STARTED' => 'Category bulk delete started successfully',
    'MESSAGE.CATEGORY_BULK_DELETE_STATUS_FETCHED' => 'Category bulk delete status fetched successfully',
    'MESSAGE.CATEGORY_BULK_DELETE_IDS_REQUIRED' => 'At least one category id is required',
    ...
    'ERROR.USER_ADMIN_CANNOT_BE_DELETED' => 'User cannot be deleted',
    ...
    'ERROR.CANNOT_DELETE_CURRENCY_IN_USE' => 'This currency cannot be deleted because it is in use',
    'ERROR.CANNOT_CHANGE_BASE_CURRENCY_FINANCIAL_ORDERS_EXIST' => 'Cannot change base currency when financial orders exist. The base currency becomes immutable after the first completed payment.',
    ...
    'MESSAGE.COUPON_ASSIGNMENTS_FETCHED_SUCCESSFULLY' => 'Assignments fetched successfully.',
    'MESSAGE.COUPON_ASSIGNED_SUCCESSFULLY' => 'Coupon assigned successfully.',
    'MESSAGE.COUPON_ASSIGNMENT_UPDATED_SUCCESSFULLY' => 'Assignment updated successfully.',
    'MESSAGE.COUPON_ASSIGNMENT_DELETED_SUCCESSFULLY' => 'Assignment removed successfully.',
    'ERROR.COUPON_ALREADY_ASSIGNED_TO_USER' => 'This coupon is already assigned to this user.',
    'ERROR.MAX_USES_BELOW_USED_COUNT' => 'max_uses cannot be less than the current usage count.',
    'ERROR.CANNOT_DELETE_ASSIGNMENT_WITH_USAGE' => 'Cannot delete assignment with usage history.',
    'MESSAGE.COUPON_CLAIMED_SUCCESSFULLY' => 'Coupon claimed successfully.',
    'ERROR.COUPON_ALREADY_CLAIMED' => 'You have already claimed this coupon.',
    ...
    'IMPORT.CATEGORY.NAME_EN_REQUIRED' => 'English name is required',
    'IMPORT.CATEGORY.NAME_AR_REQUIRED' => 'Arabic name is required',
    'IMPORT.CATEGORY.DUPLICATE_ROW' => 'Duplicate category name in the file',
    'IMPORT.CATEGORY.INVALID_STATUS' => 'Status must be 1 or 0',
    'IMPORT.CATEGORY.INVALID_IS_FEATURED' => 'is_featured must be 1 or 0',
    'IMPORT.CATEGORY.INVALID_IMAGE_URL' => 'Image URL is not a valid http/https URL',
    'IMPORT.CATEGORY.UNSAFE_IMAGE_URL' => 'Image URL is not allowed',
    'IMPORT.CATEGORY.IMAGE_DOWNLOAD_FAILED' => 'Image could not be downloaded',
    'IMPORT.CATEGORY.IMAGE_TOO_LARGE' => 'Image exceeds the maximum allowed size',
    'IMPORT.CATEGORY.UNSUPPORTED_IMAGE_TYPE' => 'Unsupported image type (JPEG, PNG and GIF are allowed)',
    'IMPORT.CATEGORY.INVALID_IMAGE_FILE' => 'Downloaded file is not a valid image',
    'IMPORT.CATEGORY.TOO_MANY_REDIRECTS' => 'Image URL has too many redirects',
    'IMPORT.CATEGORY.MISSING_PARENT' => 'Parent category not found',
    'IMPORT.CATEGORY.AMBIGUOUS_PARENT' => 'Parent name matches more than one category',
    'IMPORT.CATEGORY.AMBIGUOUS_NAME' => 'Category name matches more than one existing category',
    'IMPORT.CATEGORY.SLUG_CONFLICT' => 'Slug is already used by another category',
    'IMPORT.CATEGORY.INVALID_SLUG' => 'Category name cannot be converted into a valid slug',
    'IMPORT.CATEGORY.INVALID_PARENT' => 'Parent assignment is invalid',
    'IMPORT.CATEGORY.IMAGE_IMPORT_FAILED' => 'Image could not be saved for the category',
'IMPORT.BRAND.NAME_EN_REQUIRED' => 'English name is required',
'IMPORT.BRAND.NAME_AR_REQUIRED' => 'Arabic name is required',
'IMPORT.BRAND.DUPLICATE_ROW' => 'Duplicate brand name in the file',
'IMPORT.BRAND.INVALID_STATUS' => 'Status must be 1 or 0',
'IMPORT.BRAND.INVALID_IMAGE_URL' => 'Image URL is not a valid http/https URL',
'IMPORT.BRAND.UNSAFE_IMAGE_URL' => 'Image URL is not allowed',
'IMPORT.BRAND.IMAGE_DOWNLOAD_FAILED' => 'Image could not be downloaded',
'IMPORT.BRAND.IMAGE_TOO_LARGE' => 'Image exceeds the maximum allowed size',
'IMPORT.BRAND.UNSUPPORTED_IMAGE_TYPE' => 'Unsupported image type (JPEG, PNG and GIF are allowed)',
'IMPORT.BRAND.INVALID_IMAGE_FILE' => 'Downloaded file is not a valid image',
'IMPORT.BRAND.TOO_MANY_REDIRECTS' => 'Image URL has too many redirects',
'IMPORT.BRAND.AMBIGUOUS_NAME' => 'Brand name matches more than one existing brand',
'IMPORT.BRAND.SLUG_CONFLICT' => 'Slug is already used by another brand',
'IMPORT.BRAND.INVALID_SLUG' => 'Brand name cannot be converted into a valid slug',
'IMPORT.BRAND.IMAGE_IMPORT_FAILED' => 'Logo could not be saved for the brand',
    'MESSAGE.CATEGORY_IMPORT_STARTED' => 'Category import started successfully',
    'MESSAGE.BRAND_IMPORT_STARTED' => 'Brand import started successfully',
    'MESSAGE.BRAND_IMPORT_STATUS_FETCHED' => 'Brand import status fetched successfully',
    'MESSAGE.BRAND_EXPORT_STARTED' => 'Brand export started successfully',
    'MESSAGE.BRAND_EXPORT_STATUS_FETCHED' => 'Brand export status fetched successfully',
    'MESSAGE.EXPORT_STARTED_SUCCESSFULLY' => 'Export started successfully',
    'IMPORT.VALIDATION.IMAGES_SOURCE_REQUIRED' => 'Images source field is required (url or none)',
    'IMPORT.VALIDATION.IMAGES_SOURCE_IN' => 'Images source must be either url or none',
    'MESSAGE.CATEGORY_IMPORT_STATUS_FETCHED' => 'Category import status fetched successfully',
    'MESSAGE.CATEGORY_EXPORT_STARTED' => 'Category export started successfully',
    'MESSAGE.CATEGORY_EXPORT_STATUS_FETCHED' => 'Category export status fetched successfully',
    'MESSAGE.EXPORT_NOT_READY' => 'Export file is not ready yet',
    'MESSAGE.IMPORT_STARTED_SUCCESSFULLY' => 'Import started successfully',
    'MESSAGE.IMPORT_STATUS_FETCHED' => 'Import status fetched successfully',
    'MESSAGE.IMPORT_NO_ERRORS' => 'No errors found',
    'MESSAGE.IMPORT_CANCELLED_SUCCESSFULLY' => 'Import cancelled successfully',
    'MESSAGE.IMPORT_CANNOT_CANCEL' => 'Import cannot be cancelled in its current state',
    ...
    // ------------------------------------------------------------------
    // Legacy / shared keys kept in sync with the package constants
    // ------------------------------------------------------------------
    ...
    'ERROR.COUPON_CODE_IS_NOT_APPLICABLE_IN_THIS_SHOP_PRODUCT' => 'Coupon code is not applicable to this product',
    'ERROR.COULD_NOT_ADD_COUPON_TO_CART_NOT_VALID' => 'Could not add coupon to cart: the coupon is not valid',
    'ERROR.COULD_NOT_ADD_COUPON_TO_EMPTY_CART' => 'Could not add coupon to an empty cart',
    'ERROR.COULD_NOT_ADD_COUPON_TO_CART_YOU_HAVE_ALREADY_APPLIED_A_COUPON' => 'Could not add coupon to cart: a coupon is already applied',
    'ERROR.INVALID_COUPON_CODE_OR_COUPON_CANNOT_BE_APPLIED_OR_COUPON_USAGE_LIMIT_REACHED' => 'Could not add coupon to cart: the coupon usage limit has been reached',
    ...
    'MESSAGE.COUPON_APPLIED_SUCCESSFULLY' => 'Coupon applied successfully',
    'MESSAGE.COUPON_ALREADY_APPLIED' => 'Coupon already applied',
    ...
    'ERROR.ACCOUNT_CREATED_BUT_OTP_FAILED' => 'Account created successfully but failed to send verification code',
    'ERROR.PLEASE_VERIFY_YOUR_EMAIL' => 'Please verify your email',
    'ERROR.INVALID_OTP' => 'Invalid verification code',
    'ERROR.OTP_SEND_FAIL' => 'Failed to send verification code',
    'MESSAGE.OTP_SEND_SUCCESSFUL' => 'Verification code sent successfully',
    'MESSAGE.EMAIL_SENT_SUCCESSFUL' => 'Email sent successfully',
    'MESSAGE.EMAIL_VERIFICATION_LINK_SENT' => 'Email verification link sent to your email',
    ...
    'MESSAGE.USER_LOGGED_OUT_SUCCESSFULLY' => 'Logged out successfully',
    ...
    'MESSAGE.USER_TRASHED_LIST_RETRIEVED_SUCCESSFULLY' => 'Trashed users list retrieved successfully',
    ...
    'MESSAGE.STAFFS_LISTED_SUCCESSFULLY' => 'Staff listed successfully',
    'MESSAGE.USER_FETCHED_SUCCESSFULLY' => 'User fetched successfully',

    // Roles & Permissions
    'ERROR.PERMISSION_MISSING_ROLES' => 'User does not have the required roles.',
    'ERROR.PERMISSION_MISSING_PERMISSIONS' => 'User does not have the required permissions.',
    'ERROR.PERMISSION_MISSING_ROLES_OR_PERMISSIONS' => 'User does not have any of the required access rights.',
    'ERROR.PERMISSION_NECESSARY_ROLES' => 'Required roles are: :roles',
    'ERROR.PERMISSION_NECESSARY_PERMISSIONS' => 'Required permissions are: :permissions',
    'ERROR.PERMISSION_NECESSARY_ROLES_OR_PERMISSIONS' => 'Required roles or permissions are: :roles_or_permissions',
    'ERROR.PERMISSION_MISSING_TRAIT_HAS_ROLES' => 'The class `:class` must use the Spatie\Permission\Traits\HasRoles trait.',
    ...
    'ERROR.GUARD_DOES_NOT_MATCH' => 'The role or permission must use guard `:expected` instead of `:given`.',
    'ERROR.WILDCARD_PERMISSION_INVALID_ARGUMENT' => 'The wildcard permission must be a string, permission ID, or permission instance.',
    'ERROR.WILDCARD_PERMISSION_NOT_IMPLEMENTS_CONTRACT' => 'The wildcard permission class must implement Spatie\Permission\Contracts\Wildcard.',
    'ERROR.WILDCARD_PERMISSION_NOT_PROPERLY_FORMATTED' => 'The wildcard permission `:permission` is not properly formatted.',

    // General
    'ERROR.NOT_A_RENTAL_PRODUCT' => 'Not a rental product',
    'ERROR.NOT_AUTHORIZED' => 'You are not authorized to perform this action',
    'ERROR.PAYMENT_FAILED' => 'Payment failed',
    'ERROR.SHOP_NOT_APPROVED' => 'Shop is not approved',
    'ERROR.INSUFFICIENT_BALANCE' => 'Insufficient balance',
    'ERROR.ACTION_NOT_VALID' => 'Action is not valid',
    'ERROR.WITHDRAW_MUST_BE_ATTACHED_TO_SHOP' => 'Withdrawal must be attached to a shop',
    'ERROR.REQUIRED_INFO_MISSING' => 'Required information is missing',
    'MESSAGE.REQUIRED_INFO_MISSING' => 'Required information is missing',
    'ERROR.INVALID_GATEWAY' => 'Invalid payment gateway',
    'ERROR.OTP_VERIFICATION_FAILED' => 'OTP verification failed',
    'ERROR.CONTACT_UPDATE_FAILED' => 'Failed to update contact information',
    ...
    'ERROR.WRONG_REFUND' => 'Incorrect refund',
    ...
    'ERROR.FILED_TO_CREATE_ORDER_TRY_AGAIN' => 'Failed to create order, please try again',
    ...
    'ERROR.ALREADY_ADDED_TO_WISHLIST_FOR_THIS_PRODUCT' => 'This product is already added to the wishlist',
    ...
    'ERROR.UNAUTHORIZED_TRANSACTION_ACCESS' => 'Unauthorized transaction access',
    'ERROR.PAYMENT_GATEWAY_UNAVAILABLE' => 'Payment gateway is unavailable',

    // Fast Shipping
    'MESSAGE.FAST_SHIPPING_NOT_AVAILABLE' => 'Fast shipping is not available at the moment',
...
'ERROR.DIGITAL_ASSET_NOT_REPLACEABLE' => 'Only file assets can be replaced.','ERROR.DIGITAL_ASSET_INVALID_URL' => 'The external URL must be a valid HTTPS address.',
    ...
    'ERROR.DIGITAL_LICENSE_POOL_ONLY' => 'License keys can only be added to license pool assets.',    'ERROR.DIGITAL_ASSET_MIME_MISMATCH' => 'The file content does not match its extension.',
    'ERROR.DIGITAL_ASSET_SOFTWARE_DISABLED' => 'Software asset uploads are currently disabled.',
    ...
    'MESSAGE.FAST_SHIPPING_SETTINGS_UPDATED' => 'Fast shipping settings updated successfully',
    'MESSAGE.DEVICE_TOKEN_REGISTERED' => 'Device token registered',
    'MESSAGE.DEVICE_TOKEN_REMOVED' => 'Device token removed',
    'MESSAGE.INVOICE_PDF_NOT_GENERATED' => 'PDF not yet generated',
    'ERROR.INVOICE_DEBIT_NOTE_NOT_ALLOWED' => 'Cannot issue debit note for invoice in status: :status',
