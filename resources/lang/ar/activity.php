...
return [
    ...
    'destroy_all_products' => 'تم حذف جميع المنتجات (حذف مؤقت)',
    'products_bulk_deleted' => 'تم حذف المنتجات بشكل جماعي',
    'product_categories_synced' => 'تمت مزامنة فئات المنتج',
    'product_brands_synced' => 'تمت مزامنة العلامات التجارية للمنتج',
    'product_banners_synced' => 'تمت مزامنة لافتات المنتج',
    'product_sliders_synced' => 'تمت مزامنة سلايدرات المنتج',
    'product_tags_synced' => 'تمت مزامنة وسوم المنتج',
    'product_flash_sales_synced' => 'تمت مزامنة التخفيضات الفورية للمنتج',
    'inventory_decremented' => 'تم خصم المخزون',
    'invoice_created' => 'تم إنشاء الفاتورة',
    'activity_pruned' => 'تم تنقية سجل النشاط',
    'import_started' => 'بدأ استيراد المنتجات',
    'import_completed' => 'اكتمل استيراد المنتجات',
    'import_failed' => 'فشل استيراد المنتجات',
    'import_rolled_back' => 'تم التراجع عن استيراد المنتجات',
];
